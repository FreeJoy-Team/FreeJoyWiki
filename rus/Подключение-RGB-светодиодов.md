...
Контактов контроллера к которым можно подключить светодиоды с управлением яркостью свечения обозначены PWM в колонке LEDs в [таблице мапинга](rus/Таблица-мапинга.md).
